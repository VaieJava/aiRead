...
@MapperScan(basePackages = "com.outdd.aiRead.bam.**.dao", sqlSessionTemplateRef = "sqlSessionTemplateOne")
...
//    }
    ...
    public SqlSessionFactory sqlSessionFactoryOne(@Qualifier("dataSourceOne") DataSource dataSource)throws Exception{
        ...
        // 扫描mapper.xml
        Resource[] resources = new PathMatchingResourcePatternResolver().getResources("classpath:mappers/model/**/*.xml");
